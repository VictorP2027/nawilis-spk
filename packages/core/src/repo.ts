  ...
  return {
    ...
    signatures: {
      menyerahkan: {
        ...
        computedAt: 'device',
        namaJelas: input.signatures.menyerahkanNamaJelas ?? undefined,
        imageDataUrl: input.signatures.menyerahkanImage ?? undefined,
      },
      menerima: {
        present: input.signatures.menerimaPresent,
        namaJelas: input.signatures.menerimaNamaJelas,
